<div class="mnmd-block mnmd-block--fullwidth mnmd-featured-module-3">
            ...
            <div class="mnmd-block__inner d-flex">
                            ...
                            <div class="post__text-wrap">
                                <div class="post__text-inner post__text--spacing-1">
                                    ...
                                    <h3 class="post__title f-30 f-w-700">
                                        <a href="#">
                                            Do Well and You Will Have
                                            No Need for Ancestors
                                        </a>
                                    </h3>
                                    <div class="post__excerpt p-r-50 text-overflow">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque necessitatibus nobis fugiat ullam eligendi corporis reiciendis totam cupiditate molestias alias!
                                    </div>
                                    <div class="post__readmore post__readmore--style-1 btn-circle btn-border overlay-item--bottom-right">
                                        <a href="#">
                ...
                <div class="right-section">
                    <article class="post post--vertical atbs--post-custom post--has-btn-readmore">
                        ...
                        <div class="post__text p-l-50 p-r-35 p-b-30 post__text--spacing-1">
                            ...
                            <div class="post__excerpt text-overflow">
    ...
    <div class="sub-section">
        <div class="container">
            <div class="mnmd-block__inner align-center d-flex">
                <div class="heading-inside">
                    <h4 class="heading__title-inside f-20">trending</h4>
                </div>
                <div class="content-section__inner d-flex align-center">
                    <div class="posts-list d-flex list-horizontal mnmd-horizontal-list list-space-lg">
                        <div class="list-item">
                            <article class="post post__no-thumb">
                                <div class="post__text post__text--spacing-1">
                                    <a href="#" class="post__cat post__cat--heading-light">Travel</a>
                                    <h3 class="post__title f-16 text-capitalize">
                                        <a href="#">
                    ...
                    <a href="http://thenextmag.bk-ninja.com/default/all-posts/" target="_self" class="btn btn-default view-all">View All</a>
                </div>
            </div>
        </div>
    </div>
